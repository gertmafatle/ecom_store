...
<input type="hidden" name="return" value="http://localhost/estore/paypal_order.php?c_id=<?php echo $customer_id; ?>">


<input type="hidden" name="cancel_return" value="http://localhost/store/index.php">
